...
# https://jira.ucar.edu/browse/DSET-168 (solve AttributeError: 'InppthemePlugin' object has no attribute 'organization_facets')
...
class InppthemePlugin(plugins.SingletonPlugin):
    ''' INPP theme plugin
    '''
    ...
    def dataset_facets(self, facets_dict, package_type):
        ...
        facets_dict['inpp_region'] = plugins.toolkit._('Region')
        facets_dict['inpp_topic_category'] = plugins.toolkit._('Topic')
    ...
    def get_helpers(self):
        ...
        # other extensions.
        log.debug("InppthemePlugin adding inpptheme_get_groups_list helper")
        return {'inpptheme_get_groups_list': get_groups_list}
