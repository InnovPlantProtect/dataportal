...
shp_default_srs  = 'epsg:3763' # The SRS to use if the Shapefile has no SRS. Portugal is 'epsg:3763'
shp_override_srs = 'epsg:3763' # The SRS to use Use '' to accept the SRS inside the file, or 'epsg:3763' to override
