...
usage = '-c metadata.csv -r repo_dir [-s srs]\n' \
	...
	'-s is the SRS if the shapefile has none, eg. epsg:4326\n'
options = 'c:r:s:'
...
def process_filename(path_in_csv):
	...
	dataset_name = inppckan.inppckan_name_from_title(row['title'])
