...
sudo -u postgres psql -c "CREATE USER ckan_default1 WITH PASSWORD 'pass';" #original ckan_default
sudo -u postgres psql -c 'CREATE DATABASE ckan_test WITH OWNER ckan_default1;' #original ckan_default
